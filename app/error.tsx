    ...
    <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center p-8">
      ...
      >
        <motion.div variants={fadeInUp}>
          ...
          <motion.h1 
            className="font-serif text-[clamp(2.5rem,8vw,6rem)] leading-[0.9] text-[#F5F5F3] mb-8"
            variants={fadeInUp}
          >
          ...
          <motion.p 
            ...
            variants={fadeInUp}
          >
            Our systems experienced an unexpected disruption. 
            Our engineering team has been notified and is working to restore seamless operation.
          </motion.p>
          ...
          {error.digest && (
            <motion.p 
              className="text-[8px] tracking-[0.3em] uppercase text-[#F5F5F3]/20 mt-12"
              variants={fadeInUp}
            >
