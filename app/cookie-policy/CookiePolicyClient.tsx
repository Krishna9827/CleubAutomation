            ...
            <motion.div className="space-y-1" variants={staggerContainer}>
              {[
                ...
                },
                {
                  ...
                  technical: "Supabase Authentication, Supabase Data Integrity Checks, Secure Analytics Providers."
                }
              ].map((cookie, idx) => (
                <motion.div
                  key={idx}
            ...
            <motion.div className="space-y-4 max-w-[900px]" variants={staggerContainer}>
              {[
                ...
                },
                {
                  ...
                  desc: "We vet our third-party partners (e.g., Supabase) for their adherence to stringent data security protocols. We choose partners who reflect our commitment to discretion and technical excellence."
                },
                {
