    ...
    <div className="min-h-screen bg-[#0A0A0A] font-sans">
      ...
      >
        <div className="max-w-[1800px] mx-auto px-8 lg:px-12 py-8 flex justify-between items-center">
          <Link 
            href="/"
            className="text-[#F5F5F3] font-serif text-2xl tracking-tight hover:opacity-60 transition-opacity duration-400"
          >
            Cleub Automation
          </Link>
          ...
          <div className="max-w-[1800px] mx-auto px-8 lg:px-16">
            <motion.div className="max-w-[85%] lg:max-w-[75%]" variants={staggerContainer}>
              ...
              <motion.p 
                ...
                variants={fadeInUp}
              >
                We employ industry-leading security protocols to safeguard your data. Your information is protected by encryption, access controls, and continuous monitoring across all our systems.
              </motion.p>

              <motion.ul className="space-y-4 max-w-[700px]" variants={staggerContainer}>
                {[
                  ...
                  <motion.li
                    key={idx}
                    className="text-[#F5F5F3]/60 text-sm leading-relaxed flex gap-3"
                    variants={fadeInUp}
                  >
                    <span className="text-[#F5F5F3]/30 flex-shrink-0">•</span>
                    <span>{item}</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <motion.div variants={staggerContainer}>
                ...
                <motion.p 
                  ...
                  variants={fadeInUp}
                >
                  For questions regarding our Privacy Policy, please contact our Chief Discretion Officer (CDO) directly.
                </motion.p>
              </motion.div>
