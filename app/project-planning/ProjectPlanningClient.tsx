...
export default function ProjectPlanningClient() {
  ...
  const handleStartPlanning = async () => {
    ...
    try {
      ...
      router.push(`/room-selection?projectId=${projectId}`);
    } catch (error) {
      ...
      >
        <div className="flex justify-between items-center">
          <motion.div
            ...
            transition={{ duration: 0.8, ease: luxuryEasing as any }}
          >
            <Link href="/" className="font-serif text-2xl text-[#F5F5F3]">
              Cleub
            </Link>
          </motion.div>
