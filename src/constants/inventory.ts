...
export const TOUCH_PANEL_TYPES = ['Glass', 'Acrylic', 'Plastic'] as const
export const TOUCH_PANEL_MODULES = [2, 4, 6, 8, 12] as const
export const TOUCH_PANEL_CHANNEL_OPTIONS = [
...
export const DEFAULT_INVENTORY_PRICES = [
