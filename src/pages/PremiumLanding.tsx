    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black">
      <SiteNav
        ...
        links={[
          ...
          { label: 'Project Planning', href: '/intake' },
      ...
      <main>
        ...
        <section id="home" className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
            <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-slate-100 via-white to-slate-300">
              Beyond WiFi. Intelligent. Premium. Future‑Ready.
            </h1>
            <p className="mt-5 text-lg text-slate-400 max-w-2xl mx-auto">
              In‑house R&D, superior non‑WiFi solutions, and white‑glove service for ultra‑luxury spaces.
            </p>
            <div className="mt-8 flex justify-center gap-3">
              <Button onClick={() => navigate('/intake')} className="bg-gradient-to-r from-teal-600 to-teal-500 hover:from-teal-500 hover:to-teal-400 text-white">
                Start Requirements
              </Button>
            </div>
          </div>
              ...
              <Card className="bg-slate-900/70 border border-slate-800 shadow-xl">
                <CardContent className="p-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-slate-100">“Flawless installation and the most responsive support team we’ve worked with.”</div>
                      <div className="text-xs text-slate-400 mt-2">— A. Sharma, Luxury Villa Owner</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
              <Card className="bg-slate-900/70 border border-slate-800 shadow-xl overflow-hidden">
                <CardContent className="p-0">
                  <video className="w-full h-[220px] object-cover" autoPlay muted loop playsInline poster="/videos/testimonial-poster.jpg">
        ...
        <section id="contact" className="py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
            ...
            <p className="text-slate-400 mt-2">Consult with our experts or start a requirements sheet now.</p>
            <div className="mt-6 flex justify-center gap-3">
              <Button onClick={() => navigate('/intake')} className="bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700">Start Requirements</Button>
              <Button variant="outline" onClick={() => window.location.href = 'mailto:info@example.com'}><Mail className="w-4 h-4 mr-2" /> info@example.com</Button>
              <Button variant="outline" onClick={() => window.location.href = 'tel:+911234567890'}><Phone className="w-4 h-4 mr-2 " /> +91 12345 67890</Button>
            </div>
          </div>
        </section>
      </main>
